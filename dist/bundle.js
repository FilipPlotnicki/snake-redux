...
var directionUtils_1 = __webpack_require__(24);
var moveUtils_1 = __webpack_require__(25);
var paintUtils_1 = __webpack_require__(26);
var initialState = {
    board: {
        width: 20,
        height: 20
...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        case 'MOVE':
            return __assign({}, state, { snakePositions: moveUtils_1.move(state) });
        case 'DIR_RIGHT':
            return __assign({}, state, { direction: directionUtils_1.toRight(state) });
        case 'DIR_LEFT':
            return __assign({}, state, { direction: directionUtils_1.toLeft(state) });
        case 'DIR_TOP':
            return __assign({}, state, { direction: directionUtils_1.toTop(state) });
        case 'DIR_BOTTOM':
            return __assign({}, state, { direction: directionUtils_1.toBottom(state) });
    }
};
...
var render = function () {
    ...
    paintUtils_1.paintBoard(ctx, store.getState());
    setTimeout(function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var _changeDirection = function (direction, counterDirection) { return function (state) {
    return state.direction === counterDirection
        ? counterDirection
        : direction;
}; };
exports.toRight = _changeDirection('RIGHT', 'LEFT');
exports.toLeft = _changeDirection('LEFT', 'RIGHT');
exports.toTop = _changeDirection('TOP', 'BOTTOM');
exports.toBottom = _changeDirection('BOTTOM', 'TOP');
...
Object.defineProperty(exports, "__esModule", { value: true });
var _moveHeadBottom = function (el) { return (__assign({}, el, { y: el.y + 1 >= 20
        ? 0
        : el.y + 1 })); };
var _moveHeadTop = function (el) { return (__assign({}, el, { y: el.y - 1 <= -1
        ? 19
        : el.y - 1 })); };
var _moveHeadLeft = function (el) { return (__assign({}, el, { x: el.x - 1 <= -1
        ? 19
        : el.x - 1 })); };
var _moveHeadRight = function (el) { return (__assign({}, el, { x: el.x + 1 >= 20
        ? 0
        : el.x + 1 })); };
var _moveSnakeHead = function (dir, head) {
    switch (dir) {
        case 'RIGHT':
...
exports.move = function (state) {
    return state.snakePositions.map(function (pos, i, arr) {
        if (i === arr.length - 1)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.paintBoard = function (ctx, state) {
    ctx.fillStyle = 'rgb(0, 0, 0)';
    // those too!!!
    ctx.fillRect(0, 0, 600, 600);
    state.snakePositions.forEach(function (point, i, array) {
